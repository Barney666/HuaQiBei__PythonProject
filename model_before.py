...
same_company = current_path+"\\15.xlsx"
zcfzb = current_path+"\\1"
lrb = current_path+"\\2"
zysjb = current_path+"\\3"
xjllb = current_path+"\\4"


score_of_Macro_environment = float(90)
...
with open(current_path+"/Result_of_Whether.csv", 'r', encoding='gbk') as csvfile5:
# with open(sys.argv[7], 'r', encoding='gbk') as csvfile5:
